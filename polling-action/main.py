...
parser.add_argument('-t','--domain', help='options ["none", "basisregisters"]', default='none', required=False)
parser.add_argument('-t','--project', help='options ["none", "basisregisters"]', default='none', required=False)
